...
using GeoCybernetica.CodeGenerationExtention;

namespace CodeGenerationExtention_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new CodeGenerationExtentionPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(GeoCybernetica.CodeGenerationExtention.GuidList.guidCodeGenerationExtentionCmdSet, (int)GeoCybernetica.CodeGenerationExtention.PkgCmdIDList.showAllCommands);
